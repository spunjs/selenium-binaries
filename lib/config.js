    ...
    chromedriver: {
      ...
      download: {
        name: 'chromedriver_'
          ...
          + '.zip',
        url:'http://chromedriver.storage.googleapis.com/2.15/'
      },
      binary: {
        name: 'chromedriver' + ( isWin ? '.exe' : ''),
        path: path.resolve(SELENIUM_BINARIES_HOME, 'chromedriver', '2.15')
      }
    },
    iedriver: {
      version: '2.45.0',
      ...
      binary: {
        ...
        path: path.resolve(SELENIUM_BINARIES_HOME, 'iedriver', '2.45.0')
      }
    }
  }
};
