...
module.exports = {
  ...
  binaries: {
    selenium: {
      version: '2.43.0',
      download: {
        name: 'selenium-server-standalone-2.43.0.jar',
        url: 'http://selenium-release.storage.googleapis.com/2.43/'
      },
      binary: {
        name: 'selenium-server-standalone-2.43.0.jar',
        path: path.resolve(SELENIUM_BINARIES_HOME, 'selenium', '2.43.0')
      }
    },
    chromedriver: {
      version: '2.10',
    ...
    iedriver: {
      ...
      binary: {
        ...
        path: path.resolve(SELENIUM_BINARIES_HOME, 'iedriver', '2.43.0')
      }
    }
  }
};
